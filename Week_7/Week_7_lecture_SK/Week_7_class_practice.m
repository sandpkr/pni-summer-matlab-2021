...
load('nerve_voltage.mat');                       %%%% Load the data file 
data=nerve_voltage;                              
% data(:,2)=-1*data(:,2);
%%%%%%%%%%%%%%%%%%%%%%%% Plotting raw data %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure; 
...
[pks,locs,widths] = findpeaks(data(:,2),'MinPeakHeight',20,'MinPeakDistance',50); %%%% Peak threshold, and minimum inter peak distance
figure; 
...
peaks_hist.BinWidth = 10;    %% change this                                                     %%%% Binwidth is the width of each histogram bin
...
width_hist.BinWidth = 0.05;  %% change this                                             
